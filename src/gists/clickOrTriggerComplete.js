...
const doTheThing = async (e)=> {
    ...
    //
    let contract_address = '0x3cbdb02FD4a62e4df945a9d87A7B5A5eF8Bfcd4C'
    let token_id = '50'
    //
    //  ----------------------------------------------------------------------------------------------------------------------------
    //
    ...
    // e.player.hasNFT( 'matic', '0x3cbdb02FD4a62e4df945a9d87A7B5A5eF8Bfcd4C', '50', successCallback, failCallback)
